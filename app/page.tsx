      ...
      <section className="container grid items-center justify-center gap-6 pb-8">
        ...
        <div className="flex max-w-[980px] flex-col items-center gap-2">
          ...
          <p className="max-w-[700px] text-lg text-slate-700 dark:text-slate-400 sm:text-xl">
            Poster.ai is a free tool that uses AI to generate beautiful posters
            in seconds. Create it and print it, it's so easy, you will receive
            your poster in 3 days.
          </p>
        </div>
        <Prompt />
      </section>
